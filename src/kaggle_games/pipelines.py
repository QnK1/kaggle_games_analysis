...
class PredictiveSteamEngineer(BaseEstimator, TransformerMixin):
    """
    Custom transformer enforcing a strictly pre-release prediction horizon.
    """
    ...
    def transform(self, X):
        ...
        cols_to_drop = [
            ...
            "positive",
            "negative",
            # Target Leakage / Post-Launch variables
            "peak_ccu",
...
def get_predictive_lr_pipeline() -> Pipeline:
    # Removed all post-release engagement metrics
    skewed_features = ["price", "achievements", "dlc_count"]

    # Removed metacritic_score and discount
    standard_features = [
        "language_count",
        "tag_count",
        "release_year",
